...
<div class="form">
  ...
  <br><br>
        ...
        <div class="Name"> <h3>Enter your feedback</h3> <textarea name="comment" class="feed" rows="5" cols="40"><?php echo $feedback;?></textarea></div>
  <br><br>
    ...
    <div>
                    <a href="Thanks_FeedBack.php" target="_self">
                     <button class="buttonex1" style="vertical-align:middle">Send</button>   
                    </a>
        </div>
        </div>
